...
class JobStoriesTest extends WebTestCase
{
    /**
     ...
     * @test
     * */
    public function it_should_display_list_of_job_stories_when_hit_homepage()
    {
    ...
    public function it_should_display_list_of_top_stories()
    {
        ...
        $this->assertTrue($client->getResponse()->isOk(),'"/job-stories" routes returning error.');
