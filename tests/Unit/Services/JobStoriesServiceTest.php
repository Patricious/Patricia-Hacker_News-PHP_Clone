...
class TopStoriesServiceTest extends WebTestCase
{
     ...
     * @test
     * */
    public function it_should_return_list_of_job_stories()
    {
        ...
        // asserts
        $client->assertUrl('https://hacker-news.firebaseio.com/v0/jobstories.json');
     ...
     * @test
     * */
    public function it_should_return_empty_list_of_job_stories_when_page_is_two()
    {
        //mock the HttpClientInterface.
        FakeHttpClient::fake($this->app);
